...
## 향후 계획
✅ **STEP 1**: 수동 배포 (완료)
✅ **STEP 2**: Terraform으로 AWS 인프라 구축 (완료)
🔄 **STEP 3**: GitHub Actions로 CI/CD 구축 (진행 예정)
...
### 실행 가이드
- **Terraform 실행**: `TERRAFORM_GUIDE.md` 참고
- **GitHub Actions 설정**: `GITHUB_ACTIONS_GUIDE.md` (작성 예정)
